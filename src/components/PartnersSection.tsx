  ...
  return (
    <div className="mt-10 flex flex-col items-center justify-center gap-7 px-4 md:px-20">
        ...
        <div className="flex w-full justify-around gap-20 overflow-x-auto">
          <button onClick={() => setActiveTab('tab1')} className={`p-10 ${activeTab === 'tab1' ? 'w-full border-b-2 border-black md:w-1/2' : 'w-full md:w-1/2'}`} style={{ fontFamily: "Urbanist"}}>greenwooddesigns</button>
          <button onClick={() => setActiveTab('tab2')} className={`whitespace-nowrap p-10 font-bold ${activeTab === 'tab2' ? 'w-full border-b-2 border-black md:w-1/2' : 'w-full md:w-1/2'}`} style={{ fontFamily: "Playfair Display"}}>T & N</button>
          <button onClick={() => setActiveTab('tab3')} className={`p-10 ${activeTab === 'tab3' ? 'w-full border-b-2 border-black md:w-1/2' : 'w-full md:w-1/2'}`} style={{ fontFamily: "Urbanist"}}>elite</button>
          <button onClick={() => setActiveTab('tab4')} className={`p-10 ${activeTab === 'tab4' ? 'w-full border-b-2 border-black md:w-1/2' : 'w-full md:w-1/2'}`} style={{ fontFamily: "Unlock"}}>Urbanwood</button>
        </div>
      </div>
