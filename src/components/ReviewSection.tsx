...
function ReviewSection() {
  return (
    <div>
        <h1 className="px-4 md:px-20 pt-20 text-center text-3xl font-medium tracking-widest text-greenText" style={{ fontFamily: "Playfair Display"}}>WHAT OUR CUSTOMERS SAY</h1>
        <div className='flex flex-col md:flex-row justify-between px-4 md:px-20 gap-4 md:gap-0 pt-10'>
